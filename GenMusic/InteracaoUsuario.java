...
public class InteracaoUsuario {
	...
	public class InteracaoUsuario extends Menus { //Heranca - FormPlayer
		public static void main(String[] args) {
			Scanner leia = new Scanner(System.in);
			String nome;
			int genero, artista, resposta = 0, x = 1; //Atributos 
			
			FormPlayer reproducao = new FormPlayer(); //Objeto
			...
			while (x != 0) {
				try { //Exceptions ate linha 249(catch)
					resposta = MostraMenu();
					...
					if (resposta == 1) {
						...
						if (genero == 1) {
							...
							reproducao.iniciar();
							System.out.println("\nPróximas faixas:\n");
							System.out.println(artista1.get(2));//Encapsulamento
						...
						if (genero == 6) { //Collection no Genero Infantil 
							List<String> artista6 = new ArrayList<>(); 
							artista6.add("Super Fantástico - A turma do balão mágico");
							artista6.add("A Galinha magricela - Eliana");
							artista6.add("Livre Estou - Frozen");
							artista6.add("Dedinhos - Eliana");
